...
let rControllers = (function () {

    let _cursorId = "cursor";
    let _lefthandId = "lefthand";
    let _righthandId = "righthand";

    let _controlTypeCursor = "cursor";
    let _controlTypeQuest = "quest";
    let _controlTypeVive = "vive";
    let _controlTypeGear = "gear";
    ...
    let _controlType = _controlTypeCursor;
    ...
    AFRAME.registerComponent("auto-detect-controllers", {
        ...
        injectOculusTouch: function () {
            ...
            let options = "id:" + (this.data.hand === "left" ? _lefthandId : _righthandId);
            // options += ";ctype:oculus"
            options += ";controller:0";
            options += ";hand:" + this.data.hand; // although tracked-controls doesn't use this yet
            this.el.setAttribute(component, options);

            this.el.setAttribute("ctype", "oculus");

            setCommonControllerProperties(this.el);

            _controlType = _controlTypeQuest;
    ...
    function clearCursor() {
        ...
        fireControllersFoundEvent("controllers found");
    }
    ...
    function fireControllersFoundEvent(message)
    {
        let event = new CustomEvent('controllerdetected', { detail: message });
        rControllers.getLibElement().dispatchEvent(event);
    }

    let _libEl;
    let _hasControllers = false;

    function isUndefined(myObject)
    {
        return rvrUtil.isUndefined(myObject);
    }
    ...
    return {
        ...
        getQuestId: function() { return _controlTypeQuest;},
        getViveId: function() { return _controlTypeVive;},
        getGearId: function() { return _controlTypeGear;},
        getCursorId: function() { return _cursorId; },
        getLeftHandId: function() { return _lefthandId; },
        getRightHandId: function() { return _righthandId; },
        ...
        triggerEvent: function () {
            ...
            // fireControllersFoundEvent("test controllers found");
        }
    };
